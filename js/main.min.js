...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    window.form = form;
    form.init();
    Object(_modules_burger_menu__WEBPACK_IMPORTED_MODULE_3__["executeBurgerMenu"])();
    _modules_map__WEBPACK_IMPORTED_MODULE_2__["observer"].observe(_modules_map__WEBPACK_IMPORTED_MODULE_2__["map"]);
  });
});
...
/*!***********************************!*\
  !*** ./js/modules/burger-menu.js ***!
  \***********************************/
/*! exports provided: executeBurgerMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "executeBurgerMenu", function() { return executeBurgerMenu; });
var burgerMenu = document.querySelector('[data-burger-menu]');
var burgerMenuClosers = document.querySelectorAll('[data-burger-menu-close]');
function toggleMenu() {
...
function executeBurgerMenu() {
  burgerMenuClosers.forEach(function (closer) {
    return closer.addEventListener('click', onMenuToggle);
  });
}
